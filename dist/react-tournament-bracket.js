(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("prop-types"), require("react"), require("lodash"));
	else if(typeof define === 'function' && define.amd)
		define(["prop-types", "react", "lodash"], factory);
	else if(typeof exports === 'object')
		exports["ReactTournamentBracket"] = factory(require("prop-types"), require("react"), require("lodash"));
	else
		root["ReactTournamentBracket"] = factory(root["PropTypes"], root["React"], root["_"]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _GameShape = __webpack_require__(6);

	var _GameShape2 = _interopRequireDefault(_GameShape);

	var _winningPathLength = __webpack_require__(7);

	var _winningPathLength2 = _interopRequireDefault(_winningPathLength);

	var _BracketGame = __webpack_require__(8);
	...
	var toBracketGames = function toBracketGames(_ref) {
	  var rest = _objectWithoutProperties(_ref, []),
	      game = _ref.game,
	      GameComponent = _ref.GameComponent,
	  ...
	  )].concat((0, _lodash.chain)(game.sides)
	  ...
	  .filter(function (_ref2) {
	    ...
	    return [_react2.default.createElement('path', {
	      ...
	      fill: 'transparent',
	      stroke: 'black'
	    })].concat(toBracketGames(_extends({
	...
	Bracket.propTypes = {
	  ...
	  GameComponent: _propTypes2.default.func,
	  homeOnTop: _propTypes2.default.bool,
	  gameDimensions: _propTypes2.default.shape({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ID_TYPE = _propTypes2.default.string;

	// the shape of one side of the competition - e.g. home or visitor
	var SideShape = _propTypes2.default.shape({
	  score: _propTypes2.default.shape({
	    score: _propTypes2.default.number.isRequired
	  }),

	  seed: _propTypes2.default.shape({
	    ...
	    sourcePool: _propTypes2.default.object
	  }),

	  team: _propTypes2.default.shape({
	    id: ID_TYPE,
	    name: _propTypes2.default.string.isRequired
	  })
	});

	GameShape = _propTypes2.default.shape({
	  // optional: the label for the game within the bracket, e.g. Gold Finals, Silver Semi-Finals
	  bracketLabel: _propTypes2.default.string,
	  // where the game is played
	  court: _propTypes2.default.shape({
	    name: _propTypes2.default.string.isRequired,
	  ...
	  id: ID_TYPE,
	  name: _propTypes2.default.string.isRequired, // the game name
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function winningPathLength(game) {
	  ...
	  return 1 + ((0, _lodash.keys)(game.sides).length > 0 ? Math.max.apply(Math, (0, _lodash.map)(game.sides, function (_ref) {
	    var seed = _ref.seed;
	    return !!seed && !!seed.sourceGame && seed.rank === 1 ? winningPathLength(seed.sourceGame, visited) : 0;
	  })) : 0);
	}
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Clipped = __webpack_require__(9);

	var _GameShape = __webpack_require__(6);

	var _GameShape2 = _interopRequireDefault(_GameShape);

	var _reactControllables = __webpack_require__(15);
	  ...
	  _createClass(BracketGame, [{
	    ...
	    value: function render() {
	      var _props = this.props,
	          ...
	          rest = _objectWithoutProperties(_props, ['bottomText', 'game', 'homeOnTop', 'hoveredTeamId', 'onHoveredTeamIdChange', 'styles', 'topText']);
	...
	BracketGame.propTypes = {
	  bottomText: _propTypes2.default.func,
	  game: _GameShape2.default.isRequired,
	  homeOnTop: _propTypes2.default.bool,
	  hoveredTeamId: _propTypes2.default.string,
	  onHoveredTeamIdChange: _propTypes2.default.func.isRequired,
	  styles: _propTypes2.default.shape({
	    backgroundColor: _propTypes2.default.string.isRequired,
	    gameNameStyle: _propTypes2.default.object.isRequired,
	    hoverBackgroundColor: _propTypes2.default.string.isRequired,
	    scoreBackground: _propTypes2.default.string.isRequired,
	    teamNameStyle: _propTypes2.default.object.isRequired,
	    teamScoreStyle: _propTypes2.default.object.isRequired,
	    teamSeparatorStyle: _propTypes2.default.object.isRequired,
	    winningScoreBackground: _propTypes2.default.string.isRequired
	  }),

	  topText: _propTypes2.default.func
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	Clipped.propTypes = {
	  path: _propTypes2.default.oneOfType([_propTypes2.default.node, _propTypes2.default.arrayOf(_propTypes2.default.node)]).isRequired
	};
	...
	var RectClipped = exports.RectClipped = function (_PureComponent2) {
	  ...
	  _createClass(RectClipped, [{
	    ...
	    value: function render() {
	      ...
	      var path = _react2.default.createElement('rect', { x: x, y: y, width: width, height: height });
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var keys = _interopRequire(__webpack_require__(16));

	var omit = _interopRequire(__webpack_require__(18));

	var pick = _interopRequire(__webpack_require__(34));

	var mapValues = _interopRequire(__webpack_require__(35));

	var isArray = _interopRequire(__webpack_require__(41));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _Bracket = __webpack_require__(2);
